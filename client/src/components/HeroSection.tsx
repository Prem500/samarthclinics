          ...
          <div className="col-12 col-md-8 col-lg-6 mx-auto text-center">
            ...
            >
              ...
              <button
                ...
                className="btn btn-primary btn-lg px-4 py-2 py-md-3 shadow rounded-pill universal-button"
              >
                <i className="fa fa-calendar-check-o me-2"></i> Book Appointment
              </button>{" "}
              <a
                href="upi://pay?pa=akkiathletic@ybl"
                className="btn btn-outline-light btn-lg px-4 py-2 py-md-3 rounded-pill universal-button-outline"
              >
